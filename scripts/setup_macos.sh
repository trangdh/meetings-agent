...
cat <<'EOF'
      ...
      Plugging in headphones or waking a display can quietly switch the output
      back, which records as silence — re-run this script before a meeting that
      matters, it re-checks in seconds.
EOF
